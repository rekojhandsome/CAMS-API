...
namespace CAMS_API.Migrations
{
    ...
    [Migration("20250909093315_Added data seed for employee entity on master branch")]
    partial class Addeddataseedforemployeeentityonmasterbranch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CAMS_API.Models.Entities.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateAcquired = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeviceID = 1,
                            Price = 3000,
